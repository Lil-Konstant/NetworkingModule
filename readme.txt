...
IMPORTANT: Don't forget to add the libsndfile-1.dll and OpenAL32.dll files to whatever build directory you choose. Debug builds require both files, wheras Release builds only require OpenAL32.dll.
